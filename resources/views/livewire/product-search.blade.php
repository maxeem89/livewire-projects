    ...
    <table class="table-auto w-full">
        ...
        @foreach($products as $product)
            <tr>
                ...
                <td class="py-2 px-3 border-b "  style="width: 25%"><img class="w-16 flex justify-center" src="{{$product->image}}"></td>
                <td class="flex justify-center py-2 px-3 border-b ">{{$product->title}}</td>
